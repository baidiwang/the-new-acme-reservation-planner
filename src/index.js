...
// restaurant.id and restaurantId different?
const renderReservations = ()=> {
  const html = state.reservations.map( reservation => {
    const restaurant = state.restaurants.find(restaurant => restaurant.id === reservation.restaurantId);
    return `
